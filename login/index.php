<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $mypassword = mysqli_real_escape_string($db,sha1($_POST['password']));
      ...
      if($count == 1) {
          ...
          {
            $_SESSION['login_user'] = $myusername;
            header("location: pages/menuUser.php");
          }
...
<style>
body {
  background:url('https://vignette.wikia.nocookie.net/terraforming/images/3/36/Earth.jpg/revision/latest?cb=20151012095444');
  margin:0px;
